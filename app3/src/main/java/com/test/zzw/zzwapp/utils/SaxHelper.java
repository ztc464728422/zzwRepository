...
public class SaxHelper extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName,
        ...
        if (localName.equals("person")) {
            ...
            Log.i("SAX", "开始处理job元素~id="+attributes.getValue("id"));
        }else if(localName.equals("type")){
            Log.i("SAX", "开始处理type元素~id="+attributes.getValue("id"));
        }
    ...
    public void characters(char[] ch, int start, int length)
        ...
        if (this.tagName != null) {
            ...
            if (this.tagName.equals("name")) {
                ...
                Log.i("SAX", "处理age元素内容"+person.getAge());
            }else  if (this.tagName.equals("name2")){
                Log.i("SAX", "处理name2="+data);
            }else  if (this.tagName.equals("age2")){
                Log.i("SAX", "处理age="+data);
            }
        }
    ...
    public void endElement(String uri, String localName, String qName)
        ...
        if (localName.equals("person")) {
            ...
            Log.i("SAX", "开始处理job元素结束");
        }else if(localName.equals("type")){
            Log.i("SAX", "开始处理type元素结束");
        }
        this.tagName = null;
    }
